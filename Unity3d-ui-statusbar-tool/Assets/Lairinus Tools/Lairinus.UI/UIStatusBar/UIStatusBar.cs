...
namespace Lairinus.UI
{
    public class UIStatusBar : MonoBehaviour
    {
        ...
        public void UpdateStatusBar(float currentValue, float maxValue)
        {
            ...
            UpdateStatusBarTextValue_Internal(currentValue, maxValue, currentPercentage);
            switch (_statusBarType)
            {
                case StatusBarType.SimpleFill:
                    {
                        StatusBarTypeSimpleFill_UpdateFill_Internal(currentPercentage);
                        StatusBarTypeSimpleFill_UpdateLingeringFill_Internal(currentPercentage);
                    }
                    break;

                case StatusBarType.Quantity:
                    {
                        StatusBarTypeQuantity_UpdateValue_Internal(currentValue, maxValue, currentPercentage);
                    }
                    break;

                case StatusBarType.SeparateSprites:
                    {
                        StatusBarTypeSprites_UpdateValue_Internal(currentValue, maxValue, currentPercentage);
                    }
                    break;
            }
        }
        ...
        private void StatusBarTypeQuantity_UpdateValue_Internal(float currentValue, float maxValue, float currentPercentage)
        {
            /*
             * Internal use
             * -------------------------
             * Provides updates to the Status Bar if it's configured to show Quantities
             */
        ...
        private void StatusBarTypeSprites_UpdateValue_Internal(float currentValue, float maxValue, float currentPercentage)
        {
            /*
             * Internal use
             * -------------------------
             * Provides updates to the Status Bar if it's configured to show Separate Sprites
             */
        ...
        private void StatusBarTypeSimpleFill_UpdateFill_Internal(float currentPercentage)
        {
            /*
             * Internal use
             * -------------------------
        ...
        private void StatusBarTypeSimpleFill_UpdateLingeringFill_Internal(float currentPercentage)
        {
            /*
             * Internal use
             * -------------------------
        ...
        private void UpdateStatusBarTextValue_Internal(float currentValue, float maxValue, float currentPercentage)
        {
            /*
             * Internal use
             * -------------------------
             * Updates the Text object attached to this class instance to display the appropriate text
             */
